  ...
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu blur-3xl">
        <div className="mx-auto aspect-[1155/678] w-[72rem] bg-gradient-to-tr from-brand-200 to-brand-50 opacity-40 dark:from-brand-700 dark:to-navy-900 dark:opacity-25" />
      </div>

      <div className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-brand-100 bg-brand-50 px-4 py-1.5 text-sm font-medium text-brand-700 dark:border-navy-700 dark:bg-navy-850 dark:text-brand-300">
        ...
        <h1 className="mx-auto max-w-4xl text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-6xl">
          ...
          <span className="text-brand dark:text-brand-400">Ace Your Exams.</span>
        </h1>
